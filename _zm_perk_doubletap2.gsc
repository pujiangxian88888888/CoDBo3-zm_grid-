...
function enable_doubletap2_perk_for_level()
{
	...
	/***************************** WARDOGSK93: Start *****************************/
	zm_perks::register_perk_threads(PERK_DOUBLETAP2, &give_perk, &take_perk);
	/***************************** WARDOGSK93: End *****************************/
}
...
function doubletap2_precache()
{
	...
	addon_message = "hud|";
	addon_message += PERK_DOUBLETAP2 + "|";
	addon_message += "shader|";
	addon_message += DOUBLETAP2_SHADER;
...
function doubletap2_register_clientfield()
{
	...
	clientfield::register("toplayer", "vulture_waypoint_dtap", VERSION_SHIP, 2, "int");
}
...
function doubletap2_set_clientfield( state )
{
	...
	self clientfield::set_to_player("vulture_waypoint_dtap", state);
}
