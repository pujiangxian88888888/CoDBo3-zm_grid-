...
function widows_wine_precache()
{
	...
	/***************************** WARDOGSK93: Start *****************************/
	addon_message = "hud|";
	addon_message += PERK_WIDOWS_WINE + "|";
	addon_message += "shader|";
	addon_message += WIDOWS_WINE_SHADER;
...
function widows_wine_register_clientfield()
{
	...
	clientfield::register("toplayer", "vulture_waypoint_widows", VERSION_SHIP, 2, "int");
...
function widows_wine_set_clientfield( state )
{
	...
	self clientfield::set_to_player("vulture_waypoint_widows", state);
}
