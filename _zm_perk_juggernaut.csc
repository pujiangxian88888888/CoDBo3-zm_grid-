...
function juggernaut_client_field_func()
{
	...
	clientfield::register("toplayer", "vulture_waypoint_jugg", VERSION_SHIP, 2, "int", level.zombies_global_perk_client_callback, !CF_HOST_ONLY, CF_CALLBACK_ZERO_ON_NEW_ENT);
}
